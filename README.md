...
2. We proposed a large scale light field saliency dataset(DUTLF-FS) with 1465 paired images containing focal stack and RGB images. In addition, the dataset download link is [here](https://pan.baidu.com/s/1hq135pTjbwuda0VMocOsxw) and the fetch code is  vecy. 【Three problematic images were deleted for better use in DUTLF-FS, and a detail description can be found in dataset download files.】   
