...
2. A large scale light field saliency dataset(DUTLF-FS) with 1465 paired images containing focal stack and RGB images. In addition, the dataset download link is [here](https://pan.baidu.com/s/1hq135pTjbwuda0VMocOsxw) and the fetch code is  vecy. 
